...
| Etap | Zadanie | Czas |
|-----|---------|------|
| **Analiza** | Określenie założeń programu, w tym możliwości pobierania danych pogodowych (temperatura, wiatr) dla wybranego miasta oraz wyboru jednostek | 30 min |
| **Analiza** | Przegląd dostępnych API pogodowych i wybór serwisu wttr.in jako źródła danych | 20 min |
...
| **Testy** | Weryfikacja działania programu dla różnych lokalizacji oraz ustawień jednostek | 1h |
